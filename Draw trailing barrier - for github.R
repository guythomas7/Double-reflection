...
matplot(cbind(X[RunNo,1:N], Y_old[RunNo,1:N],  Y[RunNo,1:N], b,0,1,b_trailing[RunNo,1:N], 
                Z_t_over_M_t[RunNo,1:N], Y_running_max[RunNo,1:N], X_double_reflected[RunNo, 1:N,R] ), # tempstrike),
        ...
        cex.main = 1.6, cex.axis = 1.6, cex.lab = 1.6, xlim=c((0/52*N),(52/52*N)))  
...
text(20/52*N ,Y_running_max[RunNo, N/3] + 0.07,"    M_t", cex=1.4, col="darkorange")
